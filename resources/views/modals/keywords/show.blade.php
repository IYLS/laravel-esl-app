<!-- Modal -->
<div class="modal" id="{{ $modal_id }}" data-bs-backdrop="false" tabindex="-1" aria-labelledby="{{ $modal_id }}" aria-hidden="true" data-bs-focus="false" @if(isset($type)) data-help-type="{{ $type }}" @endif>
